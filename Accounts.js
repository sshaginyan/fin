        ...
        <ImageBackground source={require('./background.jpg')} style={{ height: '100%', width: '100%' }}>
          ...
          <Content padder >
            <View style={{
              ...
              <View style={{ flexDirection: 'row', marginTop: 50, backgroundColor: 'rgba(255, 255, 255, 0.7)', padding: 10, borderRadius: 10 }}>
                <View style={{ width: '50%' }}>
                  <Text style={{ fontWeight: 'bold', color: '#333', fontSize: 16, textAlign: 'left' }}>Bank Accounts</Text>
                  <Text style={{ color: '#333', fontSize: 14, textAlign: 'left' }}>Checking: {this.state.checkings}</Text>

        ...
        <Container>
          <Content >
            ...
            <View style={{ marginTop: 50, marginLeft: 'auto', marginRight: 'auto' }}>
              ...
              <Button onPress={() => navigate('contact', { name: 'Jane' })} style={{ marginTop: 30, backgroundColor: '#00000000', width: 360, marginBottom: 15, borderWidth: 1, borderColor: '#00B35F' }}><Text style={{ fontWeight: 'bold', marginLeft: 'auto', marginRight: 'auto', color: '#00B35F' }}>Apply Now</Text></Button>
              <Button onPress={() => navigate('contact', { name: 'Jane' })} style={{ backgroundColor: '#00B35F', width: 360, borderWidth: 1, borderColor: '#00B35F' }}><Text style={{ fontWeight: 'bold', marginLeft: 'auto', marginRight: 'auto' }}>Schedule Meeting</Text></Button>
            </View>
          </Content>
        </Container>
      );
